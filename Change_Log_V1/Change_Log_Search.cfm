...
<TABLE WIDTH="100%" CELLPADDING="1" CELLSPACING="1" bgcolor="#ffffff">
	...
	<TR>
		<td class="largeText" ></td>
		<td class="largeText"><strong>Change Log - Approved FCOs</strong></TD>
		<td class="largeText" ></td>
	</TR>
	<TR>
		<td class="largeText" ></td>
		<td class="largeText">
			<li>Use this page to view <strong>Change Log</strong> information for approved and finalized FCOs.</li>
...
<cfoutput>
	<TABLE WIDTH="100%" CELLPADDING="0" CELLSPACING="0" bgcolor="##ffffff">
		...
		<form name="frmChangeLog" action="" method="post">
			...
			<TR>
				<td class="largeText" width="1%">&nbsp;</td>
				<td class="largeText" width="13.5%">&nbsp;</td>
				<td class="largeText">&nbsp;</td>
			</TR>
		</FORM>
	</TABLE>
		...
		<TR>
			...
			<cfoutput>
				<FORM NAME="SortLogID" id="SortLogID" ACTION="" METHOD="post">
					...
					<td class="ServiceListHeader" width="8%" align="center" rowspan="2">
			...
			<td class="ServiceListHeader" width="13%" align="center" rowspan="2">Facility</td>
			<td class="ServiceListHeader" width="9%" align="center" rowspan="2">Site Manager</td>
			<td class="ServiceListHeader" width="8%" align="center" rowspan="2">Date Chevron Approved</td>
			<td class="ServiceListHeader" align="center" colspan="4">Milestone Information</td>
			<td class="ServiceListHeader" width="6%" align="center" rowspan="2">Total Value</td>
			<td class="ServiceListHeader" width="6%" align="center" rowspan="2">Status</td>
			<td class="ServiceListHeader" width="6%" align="center" rowspan="2">Oracle Process Status</td>
			<td class="ServiceListHeader" width="6%" align="center" rowspan="2">Milestone Update Status</td>
			<td class="ServiceListHeader" width="1%" align="center" rowspan="2"></td>
		</tr>
		<tr>
			<td class="ServiceListHeader" width="12%" align="center">Milestones</td>
			<td class="ServiceListHeader" width="10%" align="center">Change Type</td>
			<td class="ServiceListHeader" width="7%" align="center">Current Fee</td>
			<td class="ServiceListHeader" width="7%" align="center">New Fee</td>
		</tr>
				...
				<tr>
					...
					<FORM NAME="editSite" ACTION="" METHOD="post">
						...
						<td class="ReportBody#r#" valign="top">
							...
							<input type="hidden" name="fcotype" value="#getChangeLogs.fco_type#" />
							<cfif isDefined("form.SiteIDtofind")><input type="hidden" name="SiteIDtofind" value="#form.SiteIDtofind#" /></cfif>
							<cfif isDefined("form.SiteNameToFind")><input type="hidden" name="SiteNameToFind" value="#form.SiteNameToFind#" /></cfif>
							<cfif isDefined("form.addresstofind")><input type="Hidden" name="addresstofind" value="#form.addresstofind#"></cfif>
							<cfif isDefined("form.citytofind")><input type="Hidden" name="citytofind" value="#form.citytofind#"></cfif>
								...
								<TABLE WIDTH="100%" CELLPADDING="0" CELLSPACING="1" bgcolor="silver">
									<cfloop query="MilestoneList">
										...
										<tr>
											...
											<td class="ReportBody#r#" width="33.2%" valign="top">#MilestoneList.Milestone#</td>
											<td class="ReportBody#r#" width="28.1%" valign="top">#MilestoneList.Change_Type#</td>
											<td class="ReportBody#r#" width="19.6%" align="right" valign="top"><cfif getChangeLogs.Chevron_Approval_Status EQ "B">dollarformat(0)<cfelse>#dollarformat((CurrentValue))#</cfif></td>
											<td class="ReportBody#r#" width="19.1%" align="right" valign="top"><cfif getChangeLogs.Chevron_Approval_Status EQ "B">dollarformat(0)<cfelse>#dollarformat((NewValue))#</cfif></td>
										</tr>
									</cfloop>
								</table>
							</td>
						<cfelse>
							<td class="ReportBody#r#" valign="top" colspan="4"></td>
						</cfif>
					</cfif>
					...
					<cfif getChangeLogs.Chevron_Approval_Status EQ "S"><cfset CASClass = "ReportBodyOrange"><cfset ChevronApprovalStatus = "In Progress">
					<cfelseif getChangeLogs.Chevron_Approval_Status EQ "Y"><cfset CASClass = "ReportBodyBlue"><cfset ChevronApprovalStatus = "Pending Approval">
					<cfelseif getChangeLogs.Chevron_Approval_Status EQ "G"><cfset CASClass = "ReportBodyGreen"><cfset ChevronApprovalStatus = "Approved by Chevron">
					<cfelseif getChangeLogs.Chevron_Approval_Status EQ "B"><cfset CASClass = "ReportBodyGrey"><cfset ChevronApprovalStatus = "Rejected by Chevron">
					<cfelse><cfset CASClass = "ReportBody#r#"><cfset ChevronApprovalStatus = getChangeLogs.Chevron_Approval_Status>
					</cfif>
