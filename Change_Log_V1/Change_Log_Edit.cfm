...
<cfset ControllerList = listappend(ControllerList,MilestoneManagerList)>
...
<TABLE WIDTH="100%" CELLPADDING="1" CELLSPACING="1" bgcolor="#ffffff">
  ...
  <TR>
		...
		<td class="largeText"><strong>Change Log Form</strong></TD>
		<td class="largeText" width="1%">
	</TR>
	<TR>
		...
		<FORM NAME="ChangeAdmin" METHOD="POST" ACTION="" enctype="multipart/form-data">
			...
			<TR>
				...
				<TD class="largeText">
						<select name="AdminSiteID" class="largeText">
							<option <cfif not listfind(ControllerList,Session.Security.UserID)>disabled="true"</cfif> value="0">- select a site -</option>
							<cfloop query="getSites">
								<option <cfif not listfind(ControllerList,Session.Security.UserID)>disabled="true"</cfif> value="#getSites.Admin_Site_ID#" <cfif isDefined("form.AdminSiteID") and form.AdminSiteID EQ getSites.Admin_Site_ID>selected="selected"</cfif>>#getSites.Site_ID#, #getSites.Site_Name#, #getSites.Address#, #getSites.City#, #getSites.State_Abbreviation#</option>
							</cfloop>
						</select>
				</TD>
			</TR>
			...
			<TR>
				...
				<TD class="largeText">
						<select name="PortfolioID" class="largeText">
							<option <cfif not listfind(ControllerList,Session.Security.UserID)>disabled="true"</cfif>  value="0">- select a portfolio -</option>
							<cfloop query="getPortfolios">
								<option <cfif not listfind(ControllerList,Session.Security.UserID)>disabled="true"</cfif> value="#getPortfolios.Portfolio_ID#" <cfif isDefined("form.PortfolioID") and form.PortfolioID EQ getPortfolios.Portfolio_ID>selected="selected"</cfif>>#getPortfolios.Portfolio#</option>
							</cfloop>
						</select>
				</TD>
			</TR>
			...
			<TR>
				...
				<TD class="largeText" valign="top">
					<INPUT TYPE="text" name="ActualChangeLogID" size="20" maxlength="64" class="largeText" <cfif not listfind(ControllerList,Session.Security.UserID)>disabled="true"</cfif> VALUE="<cfif isDefined('form.ActualChangeLogID')>#form.ActualChangeLogID#</cfif>">
					&nbsp;
					<strong>Date Logged:</strong>&nbsp;
					<INPUT TYPE="text" name="DateLogged" size="12" maxlength="10" class="largeText" <cfif not listfind(ControllerList,Session.Security.UserID)>disabled="true"</cfif> VALUE="<cfif isDefined('form.DateLogged')>#form.DateLogged#</cfif>">
			...
			<TR>
				...
				<TD class="largeText" valign="top">
					<select name="InitiatingEntityID" class="largeText">
						<option <cfif not listfind(ControllerList,Session.Security.UserID)>disabled="true"</cfif> value="0">- select the entity -</option>
						<cfloop query="getChangeLogEntity">
							<option <cfif not listfind(ControllerList,Session.Security.UserID)>disabled="true"</cfif> value="#getChangeLogEntity.Initiating_Entity_ID#" <cfif isDefined("form.InitiatingEntityID") and form.InitiatingEntityID EQ getChangeLogEntity.Initiating_Entity_ID>selected="selected"</cfif>>#getChangeLogEntity.Initiating_Entity#</option>
						</cfloop>
					</select>
				</TD>
			</TR>
					...
					<table border="0" cellpadding="0" cellspacing="0" width="100%">
						<cfloop query="getChangeLogChangeType">
							...
							<td class="largeText" width="33%">
								<input type="checkbox" name="ChangeTypeID#getChangeLogChangeType.Change_Type_ID#" class="largeText" <cfif not listfind(ControllerList,Session.Security.UserID)>disabled="true"</cfif> <cfif listfind(form.listChangeType,getChangeLogChangeType.Change_Type_ID)>checked="checked"</cfif>>#getChangeLogChangeType.Change_Type#
							</td>
						...
						<tr><td class="largeText" colspan="3"><strong>
							If Other:</strong>&nbsp;
							<INPUT TYPE="text" name="ChangeTypeOther" size="67" maxlength="128" class="largeText" <cfif not listfind(ControllerList,Session.Security.UserID)>disabled="true"</cfif> VALUE="<cfif isDefined('form.ChangeTypeOther')>#form.ChangeTypeOther#</cfif>">
						</td></tr>
					</table>
				</TD>
			</TR>
				...
				<TD class="largeText" valign="top">
					<table border="0" cellpadding="0" cellspacing="0" width="100%">
						<cfloop query="getChangeLogChangeReason">
							...
							<td class="largeText">
								<input type="checkbox" name="ChangeReasonID#getChangeLogChangeReason.Change_Reason_ID#" class="largeText" <cfif not listfind(ControllerList,Session.Security.UserID)>disabled="true"</cfif> <cfif listfind(form.listChangeReason,getChangeLogChangeReason.Change_Reason_ID)>checked="checked"</cfif>>#getChangeLogChangeReason.Change_Reason#
							</td>
				...
				<TD class="largeText" valign="top">
					<table border="0" cellpadding="0" cellspacing="0" width="100%">
						<cfloop query="getChangeLogReasonDetail">
							...
							<td class="largeText">
								<input type="checkbox" name="ReasonDetailID#getChangeLogReasonDetail.Reason_Detail_ID#" class="largeText" <cfif not listfind(ControllerList,Session.Security.UserID)>disabled="true"</cfif> <cfif listfind(form.listReasonDetail,getChangeLogReasonDetail.Reason_Detail_ID)>checked="checked"</cfif>>#getChangeLogReasonDetail.Reason_Detail#
							</td>
						...
						<tr><td class="largeText" colspan="3"><strong>
							If Other:</strong>&nbsp;
							<INPUT TYPE="text" name="ReasonDetailOther" size="67" maxlength="128" class="largeText" <cfif not listfind(ControllerList,Session.Security.UserID)>disabled="true"</cfif> VALUE="<cfif isDefined('form.ReasonDetailOther')>#form.ReasonDetailOther#</cfif>">
						</td></tr>
					</table>
			...
			<TR>
				...
				<TD class="largeText" valign="top">
					<textarea name="AdditionalInformation" cols="130" rows="3" class="largeText" <cfif not listfind(ControllerList,Session.Security.UserID)>disabled="true"</cfif>><cfif isDefined("form.AdditionalInformation")>#form.AdditionalInformation#</cfif></textarea>
				</TD>
			</TR>
			...
			<TR>
				...
				<TD class="largeText" valign="top">
					<textarea name="MilestoneList" cols="130" rows="3" class="largeText" <cfif not listfind(ControllerList,Session.Security.UserID)>disabled="true"</cfif>><cfif isDefined("form.MilestoneList")>#form.MilestoneList#</cfif></textarea>
				</TD>
			</TR>
			...
			<TR>
				...
				<TD class="largeText">
					<INPUT type="text" name="ChangeValue" size="30" maxlength="14" class="largeText" <cfif not listfind(ControllerList,Session.Security.UserID)>disabled="true"</cfif> value="<cfif isDefined('form.ChangeValue')>#form.ChangeValue#<cfelse>#dollarformat(0)#</cfif>">
				</TD>
			</TR>
			...
			<TR>
				...
				<TD class="largeText" valign="top">
					<INPUT TYPE="text" name="Assumptions" size="67" maxlength="64" class="largeText" <cfif not listfind(ControllerList,Session.Security.UserID)>disabled="true"</cfif> VALUE="<cfif isDefined('form.Assumptions')>#form.Assumptions#</cfif>">
				</TD>
			</TR>
			...
			<TR>
				...
				<TD class="largeText" valign="top">
					<INPUT TYPE="text" name="PerformancePeriodEndDate" size="12" maxlength="10" class="largeText" <cfif not listfind(ControllerList,Session.Security.UserID)>disabled="true"</cfif> VALUE="<cfif isDefined('form.PerformancePeriodEndDate')>#form.PerformancePeriodEndDate#</cfif>">
			...
			<TR>
				...
				<TD class="largeText" valign="top">
					<select name="PortfolioManagerID" class="largeText">
						<option <cfif not listfind(ControllerList,Session.Security.UserID)>disabled="true"</cfif> value="0">- select the pm -</option>
						<cfloop query="getPortfolioManagers">
							<option <cfif not listfind(ControllerList,Session.Security.UserID)>disabled="true"</cfif> value="#getPortfolioManagers.User_ID#" <cfif isDefined("form.PortfolioManagerID") and form.PortfolioManagerID EQ getPortfolioManagers.User_ID>selected="selected"</cfif>>#getPortfolioManagers.Last_Name#, #getPortfolioManagers.First_Name#</option>
						</cfloop>
					</select>
					&nbsp;
					<strong>Date Approved:</strong>&nbsp;
					<INPUT TYPE="text" name="PortfolioManagerApprovalDate" size="12" maxlength="10" class="largeText" <cfif not listfind(ControllerList,Session.Security.UserID)>disabled="true"</cfif> VALUE="<cfif isDefined('form.PortfolioManagerApprovalDate')>#form.PortfolioManagerApprovalDate#</cfif>">
			...
			<TR>
				...
				<TD class="largeText" valign="top">
					<INPUT TYPE="text" name="ApprovalDescription" size="129" maxlength="1024" class="largeText" <cfif not listfind(ControllerList,Session.Security.UserID)>disabled="true"</cfif> VALUE="<cfif isDefined('form.ApprovalDescription')>#form.ApprovalDescription#</cfif>">
				</TD>
			</TR>
				...
				<TD class="largeText" valign="top">
					<select name="ChevronPMID" class="largeText">
						...
						<cfloop query="getChevronPortfolioManagers">
							<option <cfif not listfind(ControllerList,Session.Security.UserID)>disabled="true"</cfif> value="#getChevronPortfolioManagers.User_ID#" <cfif isDefined("form.ChevronPMID") and form.ChevronPMID EQ getChevronPortfolioManagers.User_ID>selected="selected"</cfif>>#getChevronPortfolioManagers.Last_Name#, #getChevronPortfolioManagers.First_Name#</option>
						</cfloop>
					</select>
					&nbsp;
					<strong>Date Approved:</strong>&nbsp;
					<INPUT TYPE="text" name="ChevronPMApprovalDate" size="12" maxlength="10" class="largeText" disabled="true" VALUE="<cfif isDefined('form.ChevronPMApprovalDate')>#form.ChevronPMApprovalDate#</cfif>">
					...
					<INPUT TYPE="text" name="Amendment" size="43" maxlength="64" class="largeText" disabled="true" VALUE="<cfif isDefined('form.Amendment')>#form.Amendment#</cfif>">
				</TD>
			</TR>
			...
			<TR>
				...
				<TD class="largeText" valign="top">
					<select name="ArcadisPMID" class="largeText">
						<option <cfif not listfind(ControllerList,Session.Security.UserID)>disabled="true"</cfif> value="0">- select a site manager -</option>
						<cfloop query="getSiteManagers">
							<option <cfif not listfind(ControllerList,Session.Security.UserID)>disabled="true"</cfif> value="#getSiteManagers.User_ID#" <cfif isDefined("form.ArcadisPMID") and form.ArcadisPMID EQ getSiteManagers.User_ID>selected="selected"</cfif>>#getSiteManagers.Last_Name#, #getSiteManagers.First_Name#</option>
						</cfloop>
					</select>
				</TD>
			</TR>
			...
			<TR>
				...
				<TD class="largeText" valign="top">
					<INPUT TYPE="text" name="EmailReference" size="125" maxlength="128" class="largeText" <cfif not listfind(ControllerList,Session.Security.UserID)>disabled="true"</cfif> VALUE="<cfif isDefined('form.EmailReference')>#form.EmailReference#</cfif>">
				</TD>
			</TR>
			...
			<TR>
				...
				<TD class="largeText" valign="top">
					<select name="ChevronApprovalStatus" class="largeText">
						<option <cfif not listfind(ControllerList,Session.Security.UserID)>disabled="true"</cfif> value="">- select the status -</option>
						<option <cfif not listfind(ControllerList,Session.Security.UserID)>disabled="true"</cfif> value="S" class="StatSilver" <cfif isDefined("form.ChevronApprovalStatus") and form.ChevronApprovalStatus EQ "S">selected="selected"</cfif>>In Progress</option>
						<option <cfif not listfind(ControllerList,Session.Security.UserID)>disabled="true"</cfif> value="Y" class="StatYellow" <cfif isDefined("form.ChevronApprovalStatus") and form.ChevronApprovalStatus EQ "Y">selected="selected"</cfif>>Pending Approval</option>
						<option <cfif not listfind(ControllerList,Session.Security.UserID)>disabled="true"</cfif> value="G" class="StatGreen" <cfif isDefined("form.ChevronApprovalStatus") and form.ChevronApprovalStatus EQ "G">selected="selected"</cfif>>Approved by Chevron</option>
						<option <cfif not listfind(ControllerList,Session.Security.UserID)>disabled="true"</cfif> value="B" class="StatBlack" <cfif isDefined("form.ChevronApprovalStatus") and form.ChevronApprovalStatus EQ "B">selected="selected"</cfif>>Rejected by Chevron</option>
					</select>
				</TD>
			</TR>
			...
			<TR>
				...
				<TD class="largeText" valign="top">
					<textarea name="OracleUpdate" cols="130" rows="3" class="largeText" <cfif not listfind(ControllerList,Session.Security.UserID)>disabled="true"</cfif>><cfif isDefined("form.OracleUpdate")>#form.OracleUpdate#</cfif></textarea>
				</TD>
			</TR>
			...
			<TR>
				...
				<TD class="largeText" valign="top">
					<select name="InternalStatus" class="largeText">
						<option <cfif not listfind(ControllerList,Session.Security.UserID)>disabled="true"</cfif> value="">- select the status -</option>
						<option <cfif not listfind(ControllerList,Session.Security.UserID)>disabled="true"</cfif> value="G" class="StatGreen" <cfif isDefined("form.InternalStatus") and form.InternalStatus EQ "G">selected="selected"</cfif>>Complete</option>
						<option <cfif not listfind(ControllerList,Session.Security.UserID)>disabled="true"</cfif> value="O" class="StatOrange" <cfif isDefined("form.InternalStatus") and form.InternalStatus EQ "O">selected</cfif>>Pending Project Close</option>
						<option <cfif not listfind(ControllerList,Session.Security.UserID)>disabled="true"</cfif> value="Y" class="StatYellow" <cfif isDefined("form.InternalStatus") and form.InternalStatus EQ "Y">selected="selected"</cfif>>Needs Follow Up</option>
						<option <cfif not listfind(ControllerList,Session.Security.UserID)>disabled="true"</cfif> value="R" class="StatRed" <cfif isDefined("form.InternalStatus") and form.InternalStatus EQ "R">selected="selected"</cfif>>Problem</option>
					</select>
				</TD>
			</TR>
			...
			<TR>
				...
				<TD class="largeText" valign="top">
					<select name="MilestoneUpdateStatus" class="largeText">
						<option <cfif not listfind(ControllerList,Session.Security.UserID)>disabled="true"</cfif> value="W" class="StatWhite" <cfif isDefined("form.MilestoneUpdateStatus") and form.MilestoneUpdateStatus EQ "">selected="selected"</cfif>>Not Applicable</option>
						<option <cfif not listfind(ControllerList,Session.Security.UserID)>disabled="true"</cfif> value="Y" class="StatYellow" <cfif isDefined("form.MilestoneUpdateStatus") and form.MilestoneUpdateStatus EQ "Y">selected="selected"</cfif>>Not Complete</option>
						<option <cfif not listfind(ControllerList,Session.Security.UserID)>disabled="true"</cfif> value="R" class="StatRed" <cfif isDefined("form.MilestoneUpdateStatus") and form.MilestoneUpdateStatus EQ "R">selected="selected"</cfif>>Needs Follow Up</option>
						<option <cfif not listfind(ControllerList,Session.Security.UserID)>disabled="true"</cfif> value="G" class="StatGreen" <cfif isDefined("form.MilestoneUpdateStatus") and form.MilestoneUpdateStatus EQ "G">selected="selected"</cfif>>Complete</option>
					</select>
				</TD>
			</TR>
			...
			<TR>
				...
				<TD class="largeText" valign="top">
					...
					<input type="File" size="50" name="FCOFileName" maxlength="64" class="fileText" <cfif not listfind(ControllerList,Session.Security.UserID)>disabled="true"</cfif>>
					<cfif isDefined("getChangeLogInfo.FCO_File_Name") and len(getChangeLogInfo.FCO_File_Name)>
						&nbsp;
						<A HREF="javascript: var n=window.open('components/GetDoc.cfm?editChangeLogID=#form.editChangeLogID#&DocType=ChangeLog#form.FCOType#', '', 'height=700,width=900,resizable')">view the document</A>
						&nbsp;
						<input type="Checkbox" name="FCODocDelete" <cfif not listfind(ControllerList,Session.Security.UserID)>disabled="true"</cfif>>delete the document
					</cfif>
				</TD>
			</TR>
