...
<cfif Attributes.VType EQ "V2">
	<cfquery name="getMilestoneList" datasource="#request.datasource#" username="#Request.UN#" password="#Request.PW#">
		...
		FROM #Request.WebSite#.dbo.Change_Log_Milestone as a
			...
			INNER JOIN #Request.WebSite#.dbo.Change_Log_Change_Type AS c ON a.Change_Type_ID = c.Change_Type_ID
			INNER JOIN #Request.WebSite#.dbo.Change_Log_Change_Reason AS d ON a.Change_Reason_ID = d.Change_Reason_ID
