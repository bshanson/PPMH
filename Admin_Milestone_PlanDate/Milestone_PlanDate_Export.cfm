...
<cfset vExpandedRowCount = (getMilestonePlanDates.RecordCount + 4)>
<cfset filterRowCount = getMilestonePlanDates.RecordCount>
<cfset row = 0>
...
<cfoutput>
 <Worksheet ss:Name="Milestones">
  <Names>
   <NamedRange ss:Name="_FilterDatabase" ss:RefersTo="=Milestones!R2C1:R#filterRowCount#C17" ss:Hidden="1"/>
  </Names>
  <Table ss:ExpandedColumnCount="17" ss:ExpandedRowCount="#vExpandedRowCount#" x:FullColumns="1" x:FullRows="1" ss:DefaultRowHeight="14.4">
   <Column ss:Width="60"/>
   <Column ss:Width="60"/>
   <Column ss:Width="200"/>
   <Column ss:Width="200"/>
   ...
   <Row>
    ...
    <Cell ss:StyleID="s17"><Data ss:Type="String">Delay Reason</Data><NamedCell ss:Name="_FilterDatabase"/></Cell>
    <Cell ss:StyleID="s17"><Data ss:Type="String">Notes</Data><NamedCell ss:Name="_FilterDatabase"/></Cell>
	 ...
	 <cfloop query="getMilestonePlanDates">
	   <Row>
	    <Cell ss:StyleID="s16"><Data ss:Type="String">#getMilestonePlanDates.ID#</Data><NamedCell ss:Name="_FilterDatabase"/></Cell>
	    <Cell ss:StyleID="s16"><Data ss:Type="String">#getMilestonePlanDates.Admin_Site_ID#</Data><NamedCell ss:Name="_FilterDatabase"/></Cell>
	    <Cell ss:StyleID="s19"><Data ss:Type="String">#getMilestonePlanDates.Site_Name#</Data><NamedCell ss:Name="_FilterDatabase"/></Cell>
	    <Cell ss:StyleID="s19"><Data ss:Type="String">#getMilestonePlanDates.Address#</Data><NamedCell ss:Name="_FilterDatabase"/></Cell>
	    <Cell ss:StyleID="s16"><Data ss:Type="String">#getMilestonePlanDates.City#</Data><NamedCell ss:Name="_FilterDatabase"/></Cell>
	    <Cell ss:StyleID="s16"><Data ss:Type="String"><cfif len(getMilestonePlanDates.State_Abbreviation) and getMilestonePlanDates.State_Abbreviation NEQ "NA">#getMilestonePlanDates.State_Abbreviation#</cfif></Data><NamedCell ss:Name="_FilterDatabase"/></Cell>
	    <Cell ss:StyleID="s16"><Data ss:Type="String">#getMilestonePlanDates.SM_Name#</Data><NamedCell ss:Name="_FilterDatabase"/></Cell>
			<Cell ss:StyleID="s16"><Data ss:Type="String">#getMilestonePlanDates.Milestone#</Data><NamedCell ss:Name="_FilterDatabase"/></Cell>
	    <Cell ss:StyleID="s16"><Data ss:Type="String">#getMilestonePlanDates.Portfolio#</Data><NamedCell ss:Name="_FilterDatabase"/></Cell>
	    <Cell ss:StyleID="s26"><Data ss:Type="Number">#getMilestonePlanDates.Milestone_Amount#</Data><NamedCell ss:Name="_FilterDatabase"/></Cell>
	    <Cell ss:StyleID="Default"><Data ss:Type="String">#getMilestonePlanDates.FCO#</Data><NamedCell ss:Name="_FilterDatabase"/></Cell>
	    ...
	    <Cell ss:StyleID="s25"><Data ss:Type="String">#Plan_Month#/#Plan_Year#</Data><NamedCell ss:Name="_FilterDatabase"/></Cell>
			...
			<Cell ss:StyleID="s25"><Data ss:Type="String"><cfif getMilestonePlanDates.Claim EQ 1>Yes<cfelse>No</cfif></Data><NamedCell ss:Name="_FilterDatabase"/></Cell>
			<Cell ss:StyleID="s25"><Data ss:Type="String"><cfif getMilestonePlanDates.Skip EQ 1>Yes<cfelse>No</cfif></Data><NamedCell ss:Name="_FilterDatabase"/></Cell>
	    <Cell ss:StyleID="s25"><Data ss:Type="String">#getMilestonePlanDates.Delay_Reason#</Data><NamedCell ss:Name="_FilterDatabase"/></Cell>
	    <Cell ss:StyleID="Default"><Data ss:Type="String">#getMilestonePlanDates.Notes#</Data><NamedCell ss:Name="_FilterDatabase"/></Cell>
	   </Row>
	 </cfloop>
   <Row>
  ...
  <AutoFilter x:Range="R1C1:R#filterRowCount#C17" xmlns="urn:schemas-microsoft-com:office:excel">
  </AutoFilter>
 </Worksheet>
</Workbook>
</cfoutput>
