...
function HM_f_MakeMenu(menucount) {
	...
	if(!NewMenu){
		...
		HM_CurrentMenu.hideSelectBoxes = HM_f_HideSelectBoxes;
		HM_CurrentMenu.unhideSelectBoxes = HM_f_UnhideSelectBoxes;
		HM_CurrentMenu.overlaps = HM_f_Overlaps;
...
function HM_f_Overlaps(obj) {
	obj1_X1 = this.xPos; obj1_X2 = obj1_X1 + this.clientWidth;
	obj1_Y1 = this.yPos; obj1_Y2 = obj1_Y1 + this.clientHeight;
	obj2_X1 = getAbsoluteLeft(obj) + document.body.scrollLeft; obj2_X2 = obj2_X1 + obj.clientWidth;
	obj2_Y1 = getAbsoluteTop(obj) + document.body.scrollTop; obj2_Y2 = obj2_Y1 + obj.clientHeight;

	return ((obj2_X2 > obj1_X1 && obj2_X2 <= obj1_X2 && obj2_Y2 > obj1_Y1 && obj2_Y2 <= obj1_Y2) ||
			(obj2_X2 > obj1_X1 && obj2_X2 <= obj1_X2 && obj2_Y1 >= obj1_Y1 && obj2_Y1 < obj1_Y2) ||
			(obj2_X1 >= obj1_X1 && obj2_X1 < obj1_X2 && obj2_Y2 > obj1_Y1 && obj2_Y2 <= obj1_Y2) ||
			(obj2_X1 >= obj1_X1 && obj2_X1 < obj1_X2 && obj2_Y1 >= obj1_Y1 && obj2_Y1 < obj1_Y2) ||
			(obj2_X1 <= obj1_X1 && obj2_X2 >= obj1_X2 && obj2_Y2 > obj1_Y1 && obj2_Y2 <= obj1_Y2) ||
			(obj2_X1 <= obj1_X1 && obj2_X2 >= obj1_X2 && obj2_Y1 >= obj1_Y1 && obj2_Y1 < obj1_Y2) ||
			(obj2_X1 <= obj1_X1 && obj2_X2 >= obj1_X2 && obj2_Y1 <= obj1_Y1 && obj2_Y2 >= obj1_Y2))
}

function HM_f_HideSelectBoxes() {
	this.hiddenSelectBoxes = new Array();
	for(i=0;i<document.forms.length;i++)
		for(j=0;j<document.forms[i].length;j++)
			if(document.forms[i].elements[j].tagName=="SELECT" && this.overlaps(document.forms[i].elements[j])) {
				document.forms[i].elements[j].style.visibility = 'hidden';
				this.hiddenSelectBoxes[this.hiddenSelectBoxes.length] = document.forms[i].elements[j]
			}
}

function HM_f_UnhideSelectBoxes() {
	if (this.hiddenSelectBoxes) {
		for(i=0;i<this.hiddenSelectBoxes.length;i++)
			this.hiddenSelectBoxes[i].style.visibility = 'visible'
		this.hiddenSelectBoxes=null;
	}
}
...
function HM_f_ShowIt(on) {
	if (!(this.tree.TopIsPermanent && (this.tree.treeParent==this))) {
		...
		on ? this.hideSelectBoxes() : this.unhideSelectBoxes();
	}
